...
<p align="center">
  <img src="https://img.shields.io/badge/Open_to_Work-00CC00?style=for-the-badge" alt="Open to Work"/>
  <a href="https://labyrinth-ai-engine.onrender.com">
    <img src="https://img.shields.io/badge/🔥_Play-Labyrinth_of_Tartarus-orange?style=for-the-badge" alt="Play Labyrinth"/>
  </a>
</p>
...
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| **Labyrinth of Tartarus** | A real-time 3D raycasting engine with ML-driven adaptive difficulty. The AI backend adjusts enemy behavior based on player performance using scikit-learn. | [▶️ Play Live](https://labyrinth-ai-engine-1.onrender.com) | [📄 View Code](https://github.com/Gift3dMyndZ/labyrinth-ai-engine) |
| **Engineering Time Dashboard**        | An interactive dashboard built with pure HTML, CSS, and JS to analyze an engineering team's time logs, featuring KPIs and dynamic SVG charts. | [**▶️ View Dashboard**](https://gift3dmyndz.github.io/Data-Science-Projects/dashboard.html)                                                      | [**📄 View Code**](./dashboard.html)                                                                     |
| **NLTK Sentiment Analyzer**           | A tool that classifies text as positive, negative, or neutral using NLTK's VADER. Includes text preprocessing and result visualization.      | [**View Project**](./projects/NLTK-Sentiment-Analyzer/)                                                                                         | [**View Code**](./projects/NLTK-Sentiment-Analyzer/)                                                    |
| **Automated Weather ETL Pipeline**    | An automated ETL pipeline that fetches, cleans, and loads daily weather data from the OpenWeatherMap API using Python and Pandas.            | [**View Project**](./projects/weather_etl/)                                                                                                     | [**View Code**](./projects/weather_etl/)                                                                |
| **Stock Price Prediction (LSTM)**     | A deep learning model using an LSTM network to forecast stock price trends based on historical Yahoo Finance data.                         | [**View Project**](./projects/stock-price-prediction/)                                                                                          | [**View Code**](./projects/stock-price-prediction/)                                                     |
...
<p align="center">
  <img src="https://img.shields.io/badge/©_2025-Mr._Joshua-orange?style=for-the-badge" alt="Copyright"/>
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/joshua-wolfe-a043a1263">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
  </a>
  <a href="mailto:YOUR_EMAIL_HERE">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/>
  </a>
  <a href="https://github.com/Gift3dMyndZ">
...
<p align="center">
  <em>⚡ Built with curiosity, coffee, and code ⚡</em>
</p>
<p align="center">
  <a href="https://gift3dmyndz.github.io/Data-Science-Projects/">
    <img src="https://img.shields.io/badge/🚀_View_Live_Portfolio-blue?style=for-the-badge" alt="View Live Portfolio"/>
